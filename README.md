...
| [MLOps with CI/CD using GitOps on AWS ECR](https://github.com/krishnamami/MLOps-CICD_GitOps_AWS) | End to End MLOps pipelines using CI/CD with GitOps and AWS ECR |
